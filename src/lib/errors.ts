...
const messages: Record<string, string> = {
  ...
  NOT_FOUND: "Batch recovery tidak ditemukan.",
  NOT_VERIFIED: "Profil Organic Processor belum terverifikasi.",
  INVALID_TRANSITION: "Status batch sudah berubah. Muat ulang data terbaru.",
  OFFER_EXPIRED: "Masa berlaku offer telah berakhir.",
  MATERIAL_TYPE_REJECTED: "Jenis material ini tidak lagi diterima fasilitas.",
  CAPACITY_EXCEEDED: "Kapasitas harian tidak mencukupi untuk batch ini.",
