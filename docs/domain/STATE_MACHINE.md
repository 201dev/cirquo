...
**Status:** Target state model with implemented M1–M5 subset
...
> `paid → picked_up` and Rescue Item expiry/routing; M5 implements Processor
> acceptance, intake, and outcome transitions.
