...
| M7 | 🧪 UAT deployment diperlukan | Verifikasi/suspensi Admin, ledger inspector read-only, moderasi, serta notifikasi lifecycle tersedia di source dan lulus pemeriksaan otomatis. Bukti ada di `M7_UAT.md`; walkthrough browser/mobile deployment masih diperlukan. |
