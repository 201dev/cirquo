...
import { estimateCo2e, summariseLedger } from '../src/lib/impact'
...
describe('impact ledger summary', () => {
  ...
  test('keeps partial outcomes, measurement adjustment, and in-progress material explicit', () => {
    const summary = summariseLedger([
      ...
      { id: 'processed', surplusItemId: 'item-a', eventType: 'PROCESSED', weightDeltaGrams: -700, metadata: JSON.stringify({ outputWeightGrams: 500, residualWeightGrams: 100 }) },
